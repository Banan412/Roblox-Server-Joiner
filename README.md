...
- **Shortened Job ID Support:** Works with both full 36-character Job IDs and shortened formats (such as the split `ba7e-6afc` format used by BTRoblox/Website list IDs). It scans up to 300 active servers to resolve and match the shortened ID.
